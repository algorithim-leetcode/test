...
class ExceptionHandlerTest {
    ...
    public void testControllerAdvice() {
        ...
        assertThat(model.getAttribute("errorTitle")).isEqualTo(ErrorCode.DATA_SAVE_ERROR.getTitle());  // 모델의 상태 검증
        assertThat(model.getAttribute("errorMessage")).isEqualTo(ErrorCode.DATA_SAVE_ERROR.getDetail());
